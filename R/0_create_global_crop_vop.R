...
terra::writeRaster(round(spam_vop_intd*1000,0),file.path(spam_dir,"global_crop_vop2020_int2015-2021_a.tif"),overwrite=T)
...
terra::writeRaster(round(spam_vop_intd_i*1000,1),file.path(spam_dir,"global_crop_vop2020_int2015-2021_i.tif"),overwrite=T)
terra::writeRaster(round(spam_vop_intd_r*1000,1),file.path(spam_dir,"global_crop_vop2020_int2015-2021_r.tif"),overwrite=T)
